...
static const unsigned int MAX_BLOCK_SIGOPS = MAX_BLOCK_SIZE/1;
static const unsigned int MAX_ORPHAN_TRANSACTIONS = MAX_BLOCK_SIZE/100;
static const int64 MIN_TX_FEE = 2000000;
static const int64 MIN_RELAY_TX_FEE = MIN_TX_FEE;
static const int64 MAX_MONEY = 10000000 * COIN; // Molecular: maximum of 10 million
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 576 / 250; // 576 blocks found a day. Priority cutoff is 1 litecoin day / 250 bytes.
    }
